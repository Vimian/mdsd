 ...
 * @generated
 */
public class LetBindingImpl extends ExpImpl implements LetBinding
{
  /**
  ...
  {
    if (baseClass == VariableBinding.class)
    {
      switch (derivedFeatureID)
      {
        case MathPackage.LET_BINDING__NAME: return MathPackage.VARIABLE_BINDING__NAME;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == VariableBinding.class)
    {
      ...
      {
        case MathPackage.VARIABLE_BINDING__NAME: return MathPackage.LET_BINDING__NAME;
        default: return -1;
      }
    }
