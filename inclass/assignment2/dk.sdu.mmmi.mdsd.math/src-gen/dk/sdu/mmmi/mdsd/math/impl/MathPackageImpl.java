...
public class MathPackageImpl extends EPackageImpl implements MathPackage
{
   ...
   */
  @Override
  public EReference getMathExp_VarExp()
  {
   ...
   */
  @Override
  public EReference getVariableExp_Exp()
  {
   ...
   */
  @Override
  public EAttribute getVariableBinding_Name()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(mathExpEClass, MATH_EXP__VAR_EXP);

    variableExpEClass = createEClass(VARIABLE_EXP);
    createEReference(variableExpEClass, VARIABLE_EXP__EXP);
    ...
    createEAttribute(variableBindingEClass, VARIABLE_BINDING__NAME);
  ...
  public void initializePackageContents()
  {
    ...
    variableExpEClass.getESuperTypes().add(this.getVariableBinding());
    letBindingEClass.getESuperTypes().add(this.getExp());
    letBindingEClass.getESuperTypes().add(this.getVariableBinding());
    ...
    initEReference(getMathExp_VarExp(), this.getVariableExp(), null, "varExp", null, 0, -1, MathExp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(variableExpEClass, VariableExp.class, "VariableExp", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getVariableExp_Exp(), this.getExp(), null, "exp", null, 0, 1, VariableExp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getVariableUse_Ref(), this.getVariableBinding(), null, "ref", null, 0, 1, VariableUse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getVariableBinding_Name(), ecorePackage.getEString(), "name", null, 0, 1, VariableBinding.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
