...
public class MathParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MathGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getVariableExpAccess().getGroup(), "rule__VariableExp__Group__0");
			...
			builder.put(grammarAccess.getMathExpAccess().getVarExpAssignment(), "rule__MathExp__VarExpAssignment");
			builder.put(grammarAccess.getVariableExpAccess().getNameAssignment_1(), "rule__VariableExp__NameAssignment_1");
			builder.put(grammarAccess.getVariableExpAccess().getExpAssignment_3(), "rule__VariableExp__ExpAssignment_3");
