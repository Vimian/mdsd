...
public class MyDslSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        EntityRoot entityRoot = (EntityRoot)theEObject;
        T result = caseEntityRoot(entityRoot);
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Entity Root</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Entity Root</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseEntityRoot(EntityRoot object)
  {
    return null;
  }
