...
public class MyDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MyDslGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getEntityRootAccess().getAlternatives_2(), "rule__EntityRoot__Alternatives_2");
			builder.put(grammarAccess.getEntityAccess().getAlternatives_2(), "rule__Entity__Alternatives_2");
			...
			builder.put(grammarAccess.getEntityRootAccess().getGroup(), "rule__EntityRoot__Group__0");
			...
			builder.put(grammarAccess.getEntityRootAccess().getNameAssignment_1(), "rule__EntityRoot__NameAssignment_1");
			builder.put(grammarAccess.getEntityRootAccess().getEntitiesAssignment_2_0(), "rule__EntityRoot__EntitiesAssignment_2_0");
			builder.put(grammarAccess.getEntityRootAccess().getRelationsAssignment_2_1(), "rule__EntityRoot__RelationsAssignment_2_1");
			builder.put(grammarAccess.getEntityAccess().getNameAssignment_1(), "rule__Entity__NameAssignment_1");
			builder.put(grammarAccess.getEntityAccess().getAttributesAssignment_2_0(), "rule__Entity__AttributesAssignment_2_0");
			builder.put(grammarAccess.getEntityAccess().getRequiresAssignment_2_1(), "rule__Entity__RequiresAssignment_2_1");
			builder.put(grammarAccess.getRequireAccess().getLeftAssignment_1(), "rule__Require__LeftAssignment_1");
			builder.put(grammarAccess.getRequireAccess().getRightAssignment_3(), "rule__Require__RightAssignment_3");
