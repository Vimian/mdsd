...
public class MathPackageImpl extends EPackageImpl implements MathPackage
{
   ...
   */
  @Override
  public EReference getExp_Operators()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(expEClass, EXP__OPERATORS);
    createEReference(expEClass, EXP__EXPS);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getExp_Operators(), this.getExpOp(), null, "operators", null, 0, -1, Exp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getExp_Exps(), this.getPrimary(), null, "exps", null, 0, -1, Exp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
