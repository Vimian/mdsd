...
public interface MathPackage extends EPackage
{
  ...
  /**
   * Returns the meta object for the containment reference list '{@link dk.sdu.mmmi.mdsd.math.Exp#getOperators <em>Operators</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Operators</em>'.
   * @see dk.sdu.mmmi.mdsd.math.Exp#getOperators()
   * @see #getExp()
   * @generated
   */
  EReference getExp_Operators();

  /**
   * Returns the meta object for the containment reference list '{@link dk.sdu.mmmi.mdsd.math.Exp#getExps <em>Exps</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Exps</em>'.
   * @see dk.sdu.mmmi.mdsd.math.Exp#getExps()
   * @see #getExp()
   * @generated
   */
  EReference getExp_Exps();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EReference EXP__OPERATORS = eINSTANCE.getExp_Operators();
     ...
     * @generated
     */
    EReference EXP__EXPS = eINSTANCE.getExp_Exps();
