...
public class VariableUseImpl extends PrimaryImpl implements VariableUse
{
   ...
   */
  @Override
  public VariableType getRef()
  {
    if (ref != null && ref.eIsProxy())
    {
      InternalEObject oldRef = (InternalEObject)ref;
      ref = (VariableType)eResolveProxy(oldRef);
      if (ref != oldRef)
      {
   ...
   * @generated
   */
  public VariableType basicGetRef()
  {
    return ref;
  }
   ...
   */
  @Override
  public void setRef(VariableType newRef)
  {
    VariableType oldRef = ref;
    ref = newRef;
    if (eNotificationRequired())
