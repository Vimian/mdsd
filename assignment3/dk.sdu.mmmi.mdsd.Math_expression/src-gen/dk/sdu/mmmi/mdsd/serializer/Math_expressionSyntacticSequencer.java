...
public class Math_expressionSyntacticSequencer extends AbstractSyntacticSequencer {

	protected Math_expressionGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (Math_expressionGrammarAccess) access;
